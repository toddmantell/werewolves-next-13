...
export default function addToNight(characterName : string, night: Set<string>) : Set<string> {
    const {firstNight, secondNight, thirdNight, fourthNight, fifthNight, sixthNight, seventhNight, eighthNight, ninthNight} = game;
